...
@Component({
  selector: 'app-cotizacion-pdf',
  templateUrl: './cotizacion-pdf.component.html',
  styleUrls: ['./cotizacion-pdf.component.scss']
})
export class CotizacionPdfComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CotizacionPdfComponent>,
