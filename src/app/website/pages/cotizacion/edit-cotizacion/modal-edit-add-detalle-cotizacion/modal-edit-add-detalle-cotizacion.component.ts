...
import { AddTerminacionEditComponent } from './add-terminacion-edit/add-terminacion-edit.component';


@Component({
  selector: 'app-modal-edit-add-detalle-cotizacion',
  templateUrl: './modal-edit-add-detalle-cotizacion.component.html',
  styleUrls: ['./modal-edit-add-detalle-cotizacion.component.scss']
})
export class ModalEditAddDetalleCotizacionComponent implements OnInit {

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<ModalEditAddDetalleCotizacionComponent>,
  ...
  ngOnInit() {
    ...
    setTimeout(() => {
      if (this.data.id_cotizacion) {
        let id = this.data.id_cotizacion
        this.id_cotizacion = Number(id)
      }
    }, 500)
