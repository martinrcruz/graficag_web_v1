...
@Component({
  selector: 'app-add-terminacion-edit',
  templateUrl: './add-terminacion-edit.component.html',
  styleUrls: ['./add-terminacion-edit.component.scss']
})
export class AddTerminacionEditComponent implements OnInit {

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private terminacionService: TerminacionService,
    public dialogRef: MatDialogRef<AddTerminacionEditComponent>
  ) { }
