...
import { AddTerminacionEditComponent } from '../modal-edit-add-detalle-cotizacion/add-terminacion-edit/add-terminacion-edit.component';


@Component({
  selector: 'app-modal-edit-edit-detalle-cotizacion',
  templateUrl: './modal-edit-edit-detalle-cotizacion.component.html',
  styleUrls: ['./modal-edit-edit-detalle-cotizacion.component.scss']
})
export class ModalEditEditDetalleCotizacionComponent implements OnInit {
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<ModalEditEditDetalleCotizacionComponent>,
  ...
  updateDetalleCotizacion() {
    ...
    // formData.append("producto", this.detalleCotizacionForm.get("producto")?.value);
  ...
  addTerminacionDetalle() {
    const dialogRef = this.dialog.open(AddTerminacionEditComponent, {
      width: "800px",
      data: {
