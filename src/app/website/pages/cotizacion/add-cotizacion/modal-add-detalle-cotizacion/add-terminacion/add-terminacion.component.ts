...
@Component({
  selector: 'app-add-terminacion',
  templateUrl: './add-terminacion.component.html',
  styleUrls: ['./add-terminacion.component.scss']
})
export class AddTerminacionComponent implements OnInit {

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private terminacionService: TerminacionService,
    public dialogRef: MatDialogRef<AddTerminacionComponent>
  ) { }
  ...
  initTerminacion() {
    if (this.data.id_detalle_cotizacion && this.data.id_categoria) {

      var id_detalle_cotizacion = this.data.id_detalle_cotizacion
      var id_categoria = this.data.id_categoria

      this.loadSavedTerminaciones(id_detalle_cotizacion)
  ...
  agregarTerminacion(id_terminacion: any) {
    ...
    formData.append("id_detalle", this.data.id_detalle_cotizacion);
    formData.append("tipo_terminacion", "C");
